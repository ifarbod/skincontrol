...
LPCSTR weaponModels[] = {
	...
	"WEAPON_BALL", "WEAPON_SNOWBALL", "WEAPON_KNUCKLE", "WEAPON_PISTOL", "WEAPON_COMBATPISTOL",
	"WEAPON_SNSPISTOL",	"WEAPON_APPISTOL", "WEAPON_PISTOL50", "WEAPON_HEAVYPISTOL", "WEAPON_VINTAGEPISTOL",
	"WEAPON_MARKSMANPISTOL", "WEAPON_STUNGUN", "WEAPON_FLAREGUN", "WEAPON_MICROSMG", "WEAPON_SMG",
	"WEAPON_ASSAULTSMG", "WEAPON_COMBATPDW", "WEAPON_MG", "WEAPON_COMBATMG", "WEAPON_GUSENBERG",
	...
	"WEAPON_SNIPERRIFLE", "WEAPON_HEAVYSNIPER", "WEAPON_MARKSMANRIFLE", "WEAPON_MUSKET", "WEAPON_GRENADELAUNCHER",
	"WEAPON_RPG", "WEAPON_FIREWORK", "WEAPON_MINIGUN", "WEAPON_RAILGUN", "WEAPON_HOMINGLAUNCHER",
...
LPCSTR weaponNames[] = {
	"Unarmed", "Knife", "Nightstick", "Hammer", "Bat", "Crowbar", "Golf Club", "Bottle", "Antique Dagger", "Hatchet", "Ball",
	"Snowball", "Knuckle Duster", "Pistol", "Combat Pistol", "SNS Pistol", "AP Pistol", ".50 Pistol", "Heavy Pistol", "Vintage Pistol", "Marksman Pistol", "Stun Gun", "Flare Gun",
	"Micro SMG", "SMG", "Assault SMG", "Combat PDW", "MG", "Combat MG", "Gusenberg", "Assault Rifle", "Carbine", "Advanced Rifle", "Special Carbine", "Bullpup Rifle",
	"Pump Shotgun", "Sawed Off", "Assault Shotgun", "Bullpup Shotgun", "Heavy Shotgun", "Sniper Rifle", "Heavy Sniper", "Markman's Rifle", "Musket",
	"Grenade Launch", "RPG", "Firework Launch", "Minigun", "Railgun", "Homing Launch", "Grenade", "Stickybomb", "Proximity Mine", "Smoke Grenade", "BZ Gas", "Flare",
	"Molotov", "Extinguisher", "Terry Can", "Scanner", "Briefcase", "Alt Briefcase" };

LPCSTR weaponComponentNames[] = {
	" ", "COMPONENT_AT_PI_FLSH", "COMPONENT_AT_AR_FLSH", "COMPONENT_AT_PI_SUPP", "component_at_pi_supp_02",
	"COMPONENT_AT_AR_SUPP", "COMPONENT_AT_AR_SUPP_02", "component_at_sr_supp", "component_at_scope_macro", "component_at_scope_macro_02",
	"COMPONENT_AT_SCOPE_SMALL", "component_at_scope_small_02", "COMPONENT_AT_SCOPE_MEDIUM", "component_at_scope_large", "COMPONENT_AT_SCOPE_LARGE_FIXED_ZOOM",
	"component_at_scope_max", "COMPONENT_AT_AR_AFGRIP", "component_pistol_clip_01", "component_pistol_clip_02", "component_combatpistol_clip_01",
	"component_combatpistol_clip_02", "component_appistol_clip_01", "component_appistol_clip_02", "component_pistol50_clip_01", "component_pistol50_clip_02",
	"COMPONENT_SNSPISTOL_CLIP_01", "COMPONENT_SNSPISTOL_CLIP_02", "COMPONENT_HEAVYPISTOL_CLIP_01", "COMPONENT_HEAVYPISTOL_CLIP_02", "COMPONENT_VINTAGEPISTOL_CLIP_01",
	"COMPONENT_VINTAGEPISTOL_CLIP_02", "COMPONENT_MICROSMG_CLIP_01", "COMPONENT_MICROSMG_CLIP_02", "COMPONENT_SMG_CLIP_01", "COMPONENT_SMG_CLIP_02",
	"COMPONENT_ASSAULTSMG_CLIP_01", "COMPONENT_ASSAULTSMG_CLIP_02", "COMPONENT_ASSAULTRIFLE_CLIP_01", "COMPONENT_ASSAULTRIFLE_CLIP_02", "COMPONENT_CARBINERIFLE_CLIP_01",
	"COMPONENT_CARBINERIFLE_CLIP_02", "COMPONENT_ADVANCEDRIFLE_CLIP_01", "COMPONENT_ADVANCEDRIFLE_CLIP_02", "COMPONENT_SPECIALCARBINE_CLIP_01", "COMPONENT_SPECIALCARBINE_CLIP_02",
	"COMPONENT_BULLPUPRIFLE_CLIP_01", "COMPONENT_BULLPUPRIFLE_CLIP_02", "COMPONENT_MG_CLIP_01", "COMPONENT_MG_CLIP_02", "COMPONENT_COMBATMG_CLIP_01",
	"COMPONENT_COMBATMG_CLIP_02", "COMPONENT_ASSAULTSHOTGUN_CLIP_01", "COMPONENT_ASSAULTSHOTGUN_CLIP_02", "COMPONENT_HEAVYSHOTGUN_CLIP_01", "COMPONENT_HEAVYSHOTGUN_CLIP_02",
	"component_sniperrifle_clip_01", "component_heavysniper_clip_01", "COMPONENT_MARKSMANRIFLE_CLIP_01", "COMPONENT_MARKSMANRIFLE_CLIP_02", "COMPONENT_GUSENBERG_CLIP_01",
	"COMPONENT_GUSENBERG_CLIP_02", "COMPONENT_COMBATPDW_CLIP_01", "COMPONENT_COMBATPDW_CLIP_02",
	"COMPONENT_KNUCKLE_VARMOD_BASE", "COMPONENT_KNUCKLE_VARMOD_PIMP", "COMPONENT_KNUCKLE_VARMOD_BALLAS", "COMPONENT_KNUCKLE_VARMOD_DOLLAR", "COMPONENT_KNUCKLE_VARMOD_DIAMOND",
	"COMPONENT_KNUCKLE_VARMOD_HATE", "COMPONENT_KNUCKLE_VARMOD_LOVE", "COMPONENT_KNUCKLE_VARMOD_PLAYER", "COMPONENT_KNUCKLE_VARMOD_KING", "COMPONENT_KNUCKLE_VARMOD_VAGOS" };
